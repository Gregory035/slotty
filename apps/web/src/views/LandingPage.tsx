import { ArrowRight, CalendarDays, Check, Command, Send, UsersRound } from 'lucide-react';
  ...
  return (
    <MarketingLayout>
      <section className="landing-hero">
        ...
        <div className="landing-actions"><Link className="primary-button lime-button" to="/app?mode=register" onClick={() => { trackEvent('landing_start_trial'); trackEvent('registration_start', { source: 'home' }); }}>Начать бесплатно <ArrowRight size={17} /></Link><a className="text-button" href="#product" onClick={() => trackEvent('landing_view_product')}>Посмотреть интерфейс</a></div>
